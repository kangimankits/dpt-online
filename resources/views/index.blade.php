    ...
    <body class="bg-light">
        <div class="container" style="max-width: 600px; margin: 5rem auto">
            <div class="card shadow shadow-sm p-4 border-0 rounded-4">
                ...
                <div id="success" class="card-body text-center d-none">
                    ...
                    <div class="mb-5 mt-3 text-start">
                        <dl>
                            <dt>NIK</dt>
                            <dd class="nik">-</dd>
                            <dt>NKK</dt>
                    ...
                    <button class="btn btn-success px-5 back">Oke</button>
                </div>
            </div>
        </div>
